...
namespace MGroup.MachineLearning.Tests
{
    public class FeedForwardNeuralNetworkLinearRegression
    {
        ...
        {
            //float[] trainX = {3.3f, 4.4f, 5.5f, 6.71f, 6.93f, 4.168f, 9.779f, 6.182f,
            //        7.59f, 2.167f, 7.042f, 10.791f, 5.313f, 7.997f, 5.654f, 9.27f, 3.1f } ;

            float[] trainX = {1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f,
                    9f, 10f };

            //float[,] trainX = { { 1, 0 }, { 1, 1 }, { 0, 0 }, { 0, 1 } };

            //float[] trainY = { 1.7f, 2.76f, 2.09f, 3.19f, 1.694f, 1.573f, 3.366f,
            //        2.596f, 2.53f, 1.221f, 2.827f, 3.465f, 1.65f, 2.904f, 2.42f, 2.94f, 1.3f } ;

            float[] trainY = {2f, 4f, 6f, 8f, 10f, 12f, 14f, 16f,
                    18f, 20f };

            //float[] trainY = { 1, 0, 0, 1 };
            ...
            var neuralNetwork = new FeedForwardNeuralNetwork2()
            {
                NumHiddenLayers = 1,
